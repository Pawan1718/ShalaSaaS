...
namespace Shala.Api.Migrations
{
    ...
    [Migration("20260424112124_registration_receipt_cancel_refund_audit")]
    partial class registration_receipt_cancel_refund_audit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shala.Domain.Entities.Registration.RegistrationFeeReceipt", b =>
                {
                    ...
                    b.HasIndex("TenantId", "BranchId", "RegistrationId", "IsCancelled");

                    b.ToTable("RegistrationFeeReceipts");
                });

            modelBuilder.Entity("Shala.Domain.Entities.Registration.RegistrationFeeReceiptAudit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "BranchId", "ReceiptId");

                    b.ToTable("RegistrationFeeReceiptAudits");
                });
            ...
            modelBuilder.Entity("Shala.Domain.Entities.Registration.StudentRegistration", b =>
                {
                    ...
                    b.HasIndex("TenantId", "BranchId", "RegistrationNo")
                        .IsUnique();
