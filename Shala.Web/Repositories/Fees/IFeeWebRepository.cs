...
public interface IFeeWebRepository
{
    ...
    Task<List<StudentFeeAssignmentResponse>> GetAssignmentsAsync(int admissionId, CancellationToken cancellationToken = default);

    Task<StudentFeeAssignmentResponse?> GetAssignmentAsync(int admissionId, CancellationToken cancellationToken = default); Task<StudentFeeAssignmentResponse> AssignFeeStructureAsync(CreateStudentFeeAssignmentRequest request, CancellationToken cancellationToken = default);
