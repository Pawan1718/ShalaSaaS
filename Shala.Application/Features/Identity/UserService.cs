...
public class UserService : IUserService
{
        ...
        CreateTenantUserRequest req)
    {
        ...
        var isSchoolAdmin = IsSchoolAdmin(actorRole);
        var isBranchAdmin = IsBranchAdmin(actorRole);
        ...
        if (isBranchAdmin)
        {
            req.DefaultBranchId = actorBranchId;
            req.AllowedBranchIds = new List<int> { actorBranchId };

            if (req.Role is Shala.Shared.Enums.AppRole.SchoolAdmin or Shala.Shared.Enums.AppRole.SuperAdmin)
                return Fail("Branch admin cannot create school admin or super admin users.");
        }
    ...
    private static bool IsSchoolAdmin(string role)
    {
    ...
    private static bool IsBranchAdmin(string role)
    {
        return role.Equals("BranchAdmin", StringComparison.OrdinalIgnoreCase);
    }
